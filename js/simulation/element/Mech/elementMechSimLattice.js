...
define(['underscore', 'backbone', 'threeModel', 'lattice', 'plist', 'emWire', 'GPUMath', "text!simulation/shaders/vertexShader.js",
    ...
    function(_, Backbone, three, lattice, plist, EMWire, gpuMath, vertexShader, velocityCalcShader, packToBytesShader,
        ...
        var ElementMechSimLattice = Backbone.Model.extend({
            ...
            setCells: function(cells, fixedIndices){
                ...
                console.log(this.cellsIndexMapping);
                ...
                if (change) require(['elementMechSim'], function(elementMechSim){
                    elementMechSim.trigger("change");//fixed indices or signals has changed
                });
